...
EN = {
    ...
    "quit.unsaved": "Save your edits before closing Folio?",
...
PATCH = {
    ...
    "quit.unsaved": {
        "es": "¿Guardar los cambios antes de cerrar Folio?",
        "fr": "Enregistrer les modifications avant de fermer Folio ?",
        "de": "Änderungen sichern, bevor Folio geschlossen wird?",
        "it": "Salvare le modifiche prima di chiudere Folio?",
        "pt-BR": "Salvar as alterações antes de fechar o Folio?",
        "pt-PT": "Guardar as alterações antes de fechar o Folio?",
        "nl": "Wijzigingen bewaren voordat je Folio sluit?",
        "da": "Gem ændringer, før Folio lukkes?",
        "sv": "Spara ändringarna innan Folio stängs?",
        "nb": "Lagre endringene før Folio lukkes?",
        "fi": "Tallennetaanko muutokset ennen Folion sulkemista?",
        "pl": "Zachować zmiany przed zamknięciem Folio?",
        "cs": "Uložit změny před ukončením Folia?",
        "hu": "Menti a módosításokat a Folio bezárása előtt?",
        "ro": "Salvezi modificările înainte de a închide Folio?",
        "el": "Αποθήκευση αλλαγών πριν κλείσει το Folio;",
        "tr": "Folio kapanmadan önce düzenlemeler kaydedilsin mi?",
        "ru": "Сохранить правки перед закрытием Folio?",
        "uk": "Зберегти зміни перед закриттям Folio?",
        "ar": "حفظ التعديلات قبل إغلاق Folio؟",
        "he": "לשמור את העריכות לפני סגירת Folio?",
        "hi": "Folio बंद करने से पहले संपादन सहेजें?",
        "th": "บันทึกการแก้ไขก่อนปิด Folio หรือไม่",
        "vi": "Lưu chỉnh sửa trước khi đóng Folio?",
        "id": "Simpan suntingan sebelum menutup Folio?",
        "ja": "Folio を閉じる前に編集を保存しますか?",
        "ko": "Folio를 닫기 전에 편집 내용을 저장할까요?",
        "zh-Hans": "关闭 Folio 前要存储编辑吗？",
        "zh-Hant": "關閉 Folio 前要儲存編輯嗎？",
    },
    "quit.discard": {
        "es": "No guardar",
